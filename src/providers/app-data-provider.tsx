...
export const AppDataProvider = ({
  ...
  const { data: uptimeData } = useQuery({
    ...
    ...TQ_DEFAULTS,
    staleTime: lightweightOptimizations ? 60_000 : 2000,
    gcTime: 5 * 60_000,
    retry: lightweightOptimizations ? 1 : 2,
    refetchInterval: lightweightOptimizations ? false : 3000,
  })
