...
const createFallbackWindow = (): CurrentWindow =>
  ({
    close: noopAsync,
    minimize: noopAsync,
    maximize: noopAsync,
    unmaximize: noopAsync,
    isMaximized: falseAsync,
    isFullscreen: falseAsync,
    setFullscreen: noopAsync,
    isDecorated: falseAsync,
    setDecorations: noopAsync,
    setMinimizable: noopAsync,
    onResized: async () => noop,
  }) as unknown as CurrentWindow
