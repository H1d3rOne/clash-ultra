...
export const translationKeys = [
  ...
  'home.components.systemInfo.fields.appVersion',
  ...
  'layout.components.navigation.tabs.ports',
  ...
  'settings.components.app.basic.title',
  'settings.components.app.basic.actions.browse',
  'settings.components.app.basic.trayOptions.showMainWindow',
  'settings.components.app.basic.trayOptions.showTrayMenu',
  'settings.components.app.basic.trayOptions.disable',
  'settings.components.app.basic.fields.language',
  'settings.components.app.basic.fields.themeMode',
  'settings.components.app.basic.fields.trayClickEvent',
  'settings.components.app.basic.fields.copyEnvType',
  'settings.components.app.basic.fields.startPage',
  'settings.components.app.basic.fields.startupScript',
  'settings.components.app.basic.fields.themeSetting',
  'settings.components.app.basic.fields.layoutSetting',
  'settings.components.app.basic.fields.misc',
  'settings.components.app.basic.fields.hotkeySetting',
  'settings.components.app.advanced.title',
  'settings.components.app.advanced.tooltips.backupInfo',
  'settings.components.app.advanced.tooltips.openConfDir',
  'settings.components.app.advanced.tooltips.liteMode',
  'settings.components.app.advanced.tooltips.defaultRuleTemplate',
  'settings.components.app.advanced.actions.copyVersion',
  'settings.components.app.advanced.notifications.latestVersion',
  'settings.components.app.advanced.notifications.versionCopied',
  'settings.components.app.advanced.fields.backupSetting',
  'settings.components.app.advanced.fields.runtimeConfig',
  'settings.components.app.advanced.fields.openConfDir',
  'settings.components.app.advanced.fields.openCoreDir',
  'settings.components.app.advanced.fields.openLogsDir',
  'settings.components.app.advanced.fields.checkUpdates',
  'settings.components.app.advanced.fields.openDevTools',
  'settings.components.app.advanced.fields.liteModeSettings',
  'settings.components.app.advanced.fields.exit',
  'settings.components.app.advanced.fields.exportDiagnostics',
  'settings.components.app.advanced.fields.appVersion',
  'settings.components.app.advanced.fields.defaultRuleTemplate',
  'settings.components.app.theme.title',
  'settings.components.app.theme.fields.primaryColor',
  'settings.components.app.theme.fields.secondaryColor',
  'settings.components.app.theme.fields.primaryText',
  'settings.components.app.theme.fields.secondaryText',
  'settings.components.app.theme.fields.infoColor',
  'settings.components.app.theme.fields.warningColor',
  'settings.components.app.theme.fields.errorColor',
  'settings.components.app.theme.fields.successColor',
  'settings.components.app.theme.fields.fontFamily',
  'settings.components.app.theme.fields.cssInjection',
  'settings.components.app.theme.actions.editCss',
  'settings.components.app.theme.dialogs.editCssTitle',
  'settings.components.app.layout.title',
  'settings.components.app.layout.fields.preferSystemTitlebar',
  'settings.components.app.layout.fields.trafficGraph',
  'settings.components.app.layout.fields.memoryUsage',
  'settings.components.app.layout.fields.proxyGroupIcon',
  'settings.components.app.layout.fields.toastPosition',
  'settings.components.app.layout.fields.hoverNavigator',
  'settings.components.app.layout.fields.hoverNavigatorDelay',
  'settings.components.app.layout.fields.navIcon',
  'settings.components.app.layout.fields.collapseNavBar',
  'settings.components.app.layout.fields.trayIcon',
  ...
  'settings.components.app.layout.fields.commonTrayIcon',
  'settings.components.app.layout.fields.systemProxyTrayIcon',
  'settings.components.app.layout.fields.tunTrayIcon',
  'settings.components.app.layout.fields.enableTrayIcon',
  ...
  'settings.components.app.layout.options.icon.monochrome',
  'settings.components.app.layout.options.icon.colorful',
  'settings.components.app.layout.options.icon.disable',
  ...
  'settings.modals.liteMode.toggles.uiOptimizations',
  'settings.modals.liteMode.tooltips.autoEnter',
  'settings.modals.liteMode.tooltips.uiOptimizations',
  ...
  'settings.modals.misc.fields.defaultSpeedTestPreset',
  'settings.modals.misc.fields.defaultSpeedTest',
  'settings.modals.misc.fields.defaultSpeedTestConcurrency',
  'settings.modals.misc.fields.defaultSpeedTestTimeout',
  ...
  'settings.modals.misc.tooltips.defaultSpeedTestPreset',
  'settings.modals.misc.tooltips.defaultSpeedTest',
  'settings.modals.misc.tooltips.defaultSpeedTestConcurrency',
  'settings.modals.misc.tooltips.defaultSpeedTestTimeout',
  ...
  'settings.modals.misc.options.speedTestPreset.custom',
  'settings.modals.misc.options.speedTestPreset.recommended',
  'settings.modals.misc.options.speedTestPreset.cloudflare',
  'settings.modals.misc.options.speedTestPreset.cachefly',
  'settings.modals.misc.options.speedTestPreset.ovh',
