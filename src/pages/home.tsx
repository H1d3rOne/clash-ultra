...
import { FluxStage } from '@/components/home/flux/flux-stage'
...
const HomePage = () => {
  ...
  }, [profiles?.items, verge?.enabled_profile_uids])

  // 文档链接函数
  const toGithubDoc = useLockFn(() => {
    return openWebUrl('https://github.com/H1d3rOne/clash-ultra#readme')
  })
  ...
  const criticalCards = useMemo(
    ...
    [enabledProfiles, mutateProfiles, renderCard],
  )
