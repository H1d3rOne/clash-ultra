...
const TestPage = () => {
  ...
  useEffect(() => {
    ...
    root.setAttribute('data-ultra-active-page', 'test')

    return () => {
      if (root.getAttribute('data-ultra-active-page') === 'test') {
