...
export const LayoutViewer = forwardRef<DialogRef>((_, ref) => {
  ...
  return (
    <BaseDialog
      open={open}
      title={t('settings.components.app.layout.title')}
      contentSx={{ width: 450 }}
      disableOk
    ...
    >
      <List>
        <Item>
          <ListItemText
            primary={t(
              'settings.components.app.layout.fields.preferSystemTitlebar',
            )}
          />
          <GuardState
            value={decorated}
        ...
        <Item>
          <ListItemText
            primary={t('settings.components.app.layout.fields.trafficGraph')}
          />
          <GuardState
        ...
        <Item>
          <ListItemText
            primary={t('settings.components.app.layout.fields.memoryUsage')}
          />
          <GuardState
        ...
        <Item>
          <ListItemText
            primary={t('settings.components.app.layout.fields.proxyGroupIcon')}
          />
          <GuardState
        ...
        <Item>
          <ListItemText
            primary={t(
              'settings.components.app.layout.fields.pauseRenderTrafficStatsOnBlur',
            )}
          />
          <GuardState
        ...
        <Item>
          <ListItemText
            primary={t('settings.components.app.layout.fields.toastPosition')}
          />
          <GuardState
          ...
          >
            <Select size="small" sx={{ width: 180, '> div': { py: '7.5px' } }}>
              <MenuItem value="top-right">
                {t(
                  'settings.components.app.layout.options.toastPosition.topRight',
                )}
              </MenuItem>
              <MenuItem value="top-left">
                {t(
                  'settings.components.app.layout.options.toastPosition.topLeft',
                )}
              </MenuItem>
              <MenuItem value="bottom-right">
                {t(
                  'settings.components.app.layout.options.toastPosition.bottomRight',
                )}
              </MenuItem>
              <MenuItem value="bottom-left">
                {t(
                  'settings.components.app.layout.options.toastPosition.bottomLeft',
                )}
              </MenuItem>
            </Select>
          </GuardState>
          ...
          <ListItemText
            primary={
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                <span>
                  {t('settings.components.app.layout.fields.hoverNavigator')}
                </span>
                <TooltipIcon
                  title={t(
                    'settings.components.app.layout.tooltips.hoverNavigator',
                  )}
                  sx={{ opacity: '0.7' }}
                />
              </Box>
          ...
          <ListItemText
            primary={
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                <span>
                  {t(
                    'settings.components.app.layout.fields.hoverNavigatorDelay',
                  )}
                </span>
                <TooltipIcon
                  title={t(
                    'settings.components.app.layout.tooltips.hoverNavigatorDelay',
                  )}
                  sx={{ opacity: '0.7' }}
                />
              </Box>
        ...
        <Item>
          <ListItemText
            primary={t('settings.components.app.layout.fields.navIcon')}
          />
          <GuardState
          ...
          >
            <Select size="small" sx={{ width: 140, '> div': { py: '7.5px' } }}>
              <MenuItem value="monochrome">
                {t('settings.components.app.layout.options.icon.monochrome')}
              </MenuItem>
              <MenuItem value="colorful">
                {t('settings.components.app.layout.options.icon.colorful')}
              </MenuItem>
              <MenuItem value="disable">
                {t('settings.components.app.layout.options.icon.disable')}
              </MenuItem>
            </Select>
          </GuardState>
        </Item>
        ...
        <Item>
          <ListItemText
            primary={t('settings.components.app.layout.fields.collapseNavBar')}
          />
          <GuardState
        ...
        {OS === 'macos' && (
          <Item>
            <ListItemText
              primary={t('settings.components.app.layout.fields.trayIcon')}
            />
            <GuardState
        ...
        {OS === 'macos' && (
          <Item>
            <ListItemText
              primary={t(
                'settings.components.app.layout.fields.enableTraySpeed',
              )}
            />
            <GuardState
        ...
        {/* {OS === "macos" && (
          <Item>
            <ListItemText primary={t("settings.components.app.layout.fields.enableTrayIcon")} />
            <GuardState
              value={
        ...
        <Item>
          <ListItemText
            primary={t(
              'settings.components.app.layout.fields.proxyGroupsDisplayMode',
            )}
          />
          <GuardState
          ...
          >
            <Select size="small" sx={{ width: 140, '> div': { py: '7.5px' } }}>
              <MenuItem value="default">
                {t(
                  'settings.components.app.layout.options.proxyGroupsDisplayMode.default',
                )}
              </MenuItem>
              <MenuItem value="inline">
                {t(
                  'settings.components.app.layout.options.proxyGroupsDisplayMode.inline',
                )}
              </MenuItem>
              <MenuItem value="disable">
                {t(
                  'settings.components.app.layout.options.proxyGroupsDisplayMode.disable',
                )}
              </MenuItem>
            </Select>
          </GuardState>
        ...
        <Item>
          <ListItemText
            primary={t(
              'settings.components.app.layout.fields.showOutboundModesInline',
            )}
          />
          <GuardState
        ...
        <Item>
          <ListItemText
            primary={t('settings.components.app.layout.fields.commonTrayIcon')}
          />
          <GuardState
          ...
          >
            ...
            >
              {verge?.common_tray_icon
                ...
                : t('settings.components.app.basic.actions.browse')}
            </Button>
          </GuardState>
        </Item>
        ...
        <Item>
          <ListItemText
            primary={t(
              'settings.components.app.layout.fields.systemProxyTrayIcon',
            )}
          />
          <GuardState
        ...
        <Item>
          <ListItemText
            primary={t('settings.components.app.layout.fields.tunTrayIcon')}
          />
          <GuardState
