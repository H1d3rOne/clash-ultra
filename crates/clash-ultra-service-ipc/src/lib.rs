...
pub static IPC_PATH: &str = "/tmp/clash-ultra/clash-ultra-service.sock";
#[cfg(all(windows, not(feature = "test")))]
pub static IPC_PATH: &str = r"\\.\pipe\clash-ultra-service";

#[cfg(all(feature = "test", unix))]
pub static IPC_PATH: &str = "/tmp/clash-ultra-service-ipc-test/service.sock";
#[cfg(all(feature = "test", windows))]
pub static IPC_PATH: &str = r"\\.\pipe\clash-ultra-service-test";
