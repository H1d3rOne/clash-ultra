...
Visit the [Release page](https://github.com/H1d3rOne/clash-ultra/releases) to download the installer that matches your platform.<br>
...
| :---------- | :-------------------------------------------------------------------- | :------------------------------------------------------------------------------------- |
| Stable      | Official builds with high reliability, ideal for daily use.           | [Release](https://github.com/H1d3rOne/clash-ultra/releases)                 |
| Alpha (EOL) | Legacy builds used to validate the publish pipeline.                  | [Alpha](https://github.com/H1d3rOne/clash-ultra/releases/tag/alpha)         |
| AutoBuild   | Rolling builds for testing and feedback. Expect experimental changes. | [AutoBuild](https://github.com/H1d3rOne/clash-ultra/releases/tag/autobuild) |

#### Installation Guides & FAQ

Read the [project documentation](https://clash-ultra.github.io/clash-ultra/) for install steps, troubleshooting, and frequently asked questions.

### Telegram Channel

Join [@clash_ultra_app](https://t.me/clash_ultra_app) for update announcements.
...
See the [FAQ page](https://clash-ultra.github.io/clash-ultra/faq/windows.html) for platform-specific guidance.

### Donation

[Support Clash Ultra development](https://github.com/sponsors/clash-ultra-app)
...
Clash Ultra builds on or draws inspiration from these projects:
