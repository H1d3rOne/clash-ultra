...
const TASK_NAME_USER: &str = "Clash Ultra";
const TASK_NAME_ADMIN: &str = "Clash Ultra (Admin)";
const TASK_XML_DIR: &str = "tasks";
const TASK_XML_USER: &str = "clash-ultra-task-user.xml";
const TASK_XML_ADMIN: &str = "clash-ultra-task-admin.xml";
...
async fn cleanup_legacy_shortcuts() -> Result<()> {
    ...
    let new_shortcut = startup_dir.join("Clash Ultra.lnk");
